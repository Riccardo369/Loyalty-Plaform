...
public class GeneralManagement {
    ...
    public static final boolean DestroyCollaborazioniScadute(){
        DatabaseQuery Response = UserDatabaseRequest.SendRequest("select PartitaIVAStart, PartitaIVAFinish, Scadenza from piano_vantaggi");

        ArrayList<String> Result = new ArrayList<>();

        for(int i=0; i<Response.GetRowCount(); i++){
            if(Timestamp.valueOf(Response.GetValue(i, "Scadenza")).compareTo(new Timestamp(System.currentTimeMillis())) < 0){
                Result.add("(PartitaIVAStart = '"+Response.GetValue(i, "PartitaIVAStart")+"' and PartitaIVAFinish = '"+Response.GetValue(i, "PartitaIVAFinish")+"')");
            }
        }
        ...
        UserDatabaseRequest.SendRequest("delete from piano_vantaggi where "+Stringa);
    ...
    //Recensione sito
    public static final boolean AddRecensioneSito(String PartitaIVA, String Nickname, String Descrizione, float Stelle, Timestamp TemporalPoint) { return false; }
    public static final Object GetRecensioneSito(String PartitaIVA, String Nickname) { return null; }
    public static final boolean RemoveRecensioneSito(String PartitaIVA, String Nickname) { return false; }
